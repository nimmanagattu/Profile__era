...
const Pricing = () => {
    const packages = [
        ...
        },
        {
            ...
            price: "₹25,000",
            color: "blue",
            who: ["Associate Level", "Looking to switch roles or companies"],
        ...
        },
        {
            ...
            price: "₹35,000",
            color: "red",
            who: ["Senior Level", "Stagnant growth or compensation", "Targeting senior or specialized roles"],
    ...
    return (
        <section id="pricing" className="py-24 bg-white border-t border-gray-100 scroll-mt-20">
                    ...
                    {packages.map((pkg, i) => (
                        ...
                        >
                            ...
                            <div className="mb-8">
                                ...
                                {pkg.subtitle && <p className="text-sm font-bold text-gray-500 uppercase tracking-widest">{pkg.subtitle}</p>}
                            </div>
