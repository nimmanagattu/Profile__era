...
const AdminDashboard = ({ adminKey, onLogout }) => {
    ...
    const stats = [
        ...
        { label: 'Resumes', value: leads.filter(l => l.resume !== "No resume uploaded").length, icon: <Download size={20} />, color: 'green' }
    ];
                                ...
                                <tbody className="divide-y divide-blue-50">
                                    {filteredLeads.map((lead, i) => (
                                        ...
                                        >
                                            ...
                                            <td className="px-8 py-6">
                                                {lead.resume !== "No resume uploaded" ? (
                                                    <a
                                                        href={lead.resume}
                                                        target="_blank"
                                                        rel="noreferrer"
                                                        className="flex items-center gap-2 text-xs font-bold text-green-600 bg-green-50 px-3 py-2 rounded-lg hover:bg-green-100 transition-colors w-fit"
                                                    >
                                                        <Download size={14} />
                                                        VIEW CV
                                                    </a>
                                                ) : (
                                                    <span className="text-[10px] font-black text-gray-300 uppercase italic">No Resume</span>
                                                )}
                                            </td>
